var NewsHub = (() => {
  ...
  var _Lightbox = class {
    ...
    open(ev) {
      ...
      if (this.modal) {
        ev.preventDefault();
        let slideTo = ev.target.closest("[data-lightbox-slide-to]");
        this.lightbox.addEventListener("show.bs.modal", (ev2) => {
          if (slideTo) {
    ...
    createLightbox() {
      ...
      this.modal = new window["Bootstrap"].Modal(lightbox);
  ...
  Lightbox.instances = /* @__PURE__ */ new Map();
