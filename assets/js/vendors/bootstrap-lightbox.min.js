                    ...
                    <div class="modal-body p-0">
                        <div id="${this.config.carousel.id||"lightboxCarousel"}" class="carousel carousel-fade slide">
                            ...
                            <div class="carousel-inner">
                                ${Array.from(this.items.values()).map((a,o)=>`
