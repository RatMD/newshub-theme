(() => {
  ...
  var getSelectorFromElement = /* @__PURE__ */ __name((element) => {
  ...
  var getElementFromSelector = /* @__PURE__ */ __name((element) => {
    const selector = getSelector(element);
  ...
  var execute = /* @__PURE__ */ __name((callback) => {
  ...
  __name(ScrollBarHelper, "ScrollBarHelper");
  var NAME$9 = "backdrop";
